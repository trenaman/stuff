...
import com.fusesource.activemq.history.KahaDBMessageHistory.IndividualMessageHistory;
import java.io.File;
...
public abstract class MessageHistory {
    ...
    protected void logMessage(Logger log, Message msg, long size, IndividualMessageHistory history) {
        ...
        try {
            ...
            log.info("Payload: \n" + payloadAsString(msg));
            log.info("Dequeued (by client or DLQ): " + history.acknowledged);
            log.info("======");
        } catch (Exception ex) {
